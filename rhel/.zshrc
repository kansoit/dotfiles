# ~/.zshrc - Configuración de Zsh para RHEL / Rocky / Fedora (Modular y sin dependencias de Arch)
...
# --- Plugins de Zsh (Prioridad: ~/.zsh/ gestionado por Ansible, luego rutas RHEL/Fedora) ---
