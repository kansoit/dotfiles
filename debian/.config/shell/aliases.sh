# ~/.config/shell/aliases.sh - Alias compartidos para Bash y Zsh en Debian / Ubuntu
# shellcheck shell=sh
...
# --- Compatibilidad de binarios en Debian / Ubuntu ---
...
# Detección de binario bat para pipes y coloreado
_BAT_BIN=""
...
# --- Notificación de tareas largas (entornos gráficos) ---
