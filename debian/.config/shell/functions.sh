# ~/.config/shell/functions.sh - Funciones compartidas para Bash y Zsh en Debian / Ubuntu
...
# --- Páginas de manual coloreadas con bat / batcat ---
man() {
  local bat_cmd=""
...
# --- Explorador interactivo con eza, fzf y batcat / bat ---
fp() {
